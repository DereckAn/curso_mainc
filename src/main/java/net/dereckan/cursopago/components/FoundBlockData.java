...
public class FoundBlockData {
    ...
    public String getOutputString(){
        return block.getBlock().asItem().getName().getString() + " at " + position.getX() + ", " + position.getY() + ", " + position.getZ();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == this) {
            ...
            return obj instanceof FoundBlockData fbd &&
                    this.block == fbd.block &&
                    this.position == fbd.position;
        }
    }
}
